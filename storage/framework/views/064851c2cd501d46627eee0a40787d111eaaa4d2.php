				...
				<h2 class="inner-tittle" style="margin-bottom: 0.5em;">Panel 3.0 Pro || <?php echo e(Request::path()); ?></h2>
					...
					<div class="col-md-12" style=""></div>
							<table id="tabla" class="display" cellspacing="0" width="100%">
						        ...
						        <tbody>
						        	<?php $__currentLoopData = $dolar_t; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dolar_v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							    		<tr>
									      <td class="col-md-2"><?php echo e($dolar_v->id); ?></td>
									      <td class="col-md-6">$<?php echo e($dolar_v->valor); ?>-</td>
									      <td class="col-md-4"><?php echo e($dolar_v->created_at); ?></td>
									    </tr>
