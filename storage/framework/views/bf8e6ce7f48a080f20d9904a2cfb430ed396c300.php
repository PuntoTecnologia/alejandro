...
<div class="contenedor_orden">
	...
	<div style="float: right;">Orden de trabajo: <?php echo e($repair2[0]->id); ?></div>
	<div class="linea_1">
		...
		<tr>
			<td style="padding:2mm;">
				...
				<div>Cliente: <?php echo e($repair2[0]->name); ?> <?php echo e($repair2[0]->last_name); ?></div>
				<div>Cuit / Cuil: <?php echo e($repair2[0]->cuit_cuil); ?> </div>
				<div>Telefono: <?php echo e($repair2[0]->telefono); ?> </div>
				<div>E-mail: <?php echo e($repair2[0]->email); ?> </div>
			</td>
			<td>
				
				<div>Marca/Modelo: <?php echo e($repair2[0]->marca_modelo); ?> </div>
				<div>Salvar datos: <?php if($repair2[0]->datos == 1): ?>
					Si
				<?php else: ?>
					No
				<?php endif; ?> </div>
				<div>Problema / Trabajo a realizar </div>
				<div style="font-weight: bold;"><?php echo e($repair2[0]->descripcion); ?> </div>
			</td>
		<div class="separador"></div>
