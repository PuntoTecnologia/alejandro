				...
				<div class="col-md-12" style="padding-top: 3em;">
							...
							<table id="tabla" class="display" cellspacing="0" width="100%">
						        ...
						        <tbody>
						        	...
						        	<?php $__currentLoopData = $productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							    		...
							    		<tr>
									      <td class="col-md-2">
									      	<?php $__currentLoopData = $img_productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										      	<?php if($element->id == $img->producto_id && $count == 0): ?>
										      		<img src="/uploads/<?php echo e($element->id); ?>/min_<?php echo e($img->file_name); ?>" class="img-responsive" alt="" style="width: 50%;">
										      	<?php $count=1; ?>
										      	<?php $exist='1'; ?>
										      	<?php $file_name=$img->file_name; ?>
										      	<?php endif; ?>
