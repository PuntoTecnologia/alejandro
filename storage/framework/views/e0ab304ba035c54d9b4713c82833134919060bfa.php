...
<div class="tab-main">
			<div id="tabs" class="tabs">
				...
				<div class="col-md-5">
					...
					<input value="<?php echo e($clients->name); ?>" class="form-control" type="text" name="name" style="width: 100%;" required readonly>
				</div>
				<div class="col-md-5">
					<label>Apellido</label>
					<input value="<?php echo e($clients->last_name); ?>" class="form-control" type="text" name="last_name" style="width: 100%;" required readonly>
				</div>
				<div class="col-md-2">
					<label>Cuit - Cuil - Dni</label>
					<input value="<?php echo e($clients->cuit_cuil); ?>" class="form-control" type="text" name="cuit_cuil" style="width: 100%;" required readonly>
				</div>
				<!-- //////////////////////////////////////////////  -->
				<div class="col-md-4">
					<label>Telefono</label>
					<input value="<?php echo e($clients->telefono); ?>" class="form-control" type="text" name="telefono" style="width: 100%;" required readonly>
				</div>
				<div class="col-md-4">
					<label>Correo Electronico</label>
					<input value="<?php echo e($clients->email); ?>" class="form-control" type="text" name="id" style="width: 100%;" required readonly>
				</div>
				<!-- //////////////////////////////////////////////  -->
				<div class="col-md-12">
					<h2>Datos Equipo</h2>
				...
				<div class="col-md-12 form-title" style="margin-bottom: 1em;">
					<input style="float: right;margin: 0.5em;" type="submit" class="btn btn-primary" value="Terminar/Imprimir">
				</div>
				</form>
			</div>
		</div>
