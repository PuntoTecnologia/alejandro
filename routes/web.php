...
Route::get('/GetProductos', 'PanelController@getProductos');
...
//CRUTAS DE ARTICULO
Route::get('/EDITAR-ARTICULO/{id}', 'ProductController@edit')->middleware('auth');
Route::patch('/EDITAR_ARTICULO_INFO/{product}', 'ProductController@update_info')->middleware('auth');
Route::get('/EDITAR-ARTICULO-IMG/{id}', 'ProductController@update_img_view')->middleware('auth');
...
Route::delete('/ELIMINAR-ARTICULO/{id}', 'ProductController@destroy_art')->middleware('auth');
//RUTA DE MENSAJES
